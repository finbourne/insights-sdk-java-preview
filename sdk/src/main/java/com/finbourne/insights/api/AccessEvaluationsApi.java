...
public class AccessEvaluationsApi {
    ...
    /**
     * [EXPERIMENTAL] GetAccessEvaluationLog: Get the log for a specific access evaluation.  This endpoint will be deprecated in the near future. (asynchronously)
     * 
     * @param id The identifier of the access evaluation to obtain the log for. (required)
     ...
     */
    public okhttp3.Call listAccessEvaluationLogsCall(OffsetDateTime startAt, OffsetDateTime endAt, String filter, String sortBy, Integer limit, String page, String histogramInterval, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call listAccessEvaluationLogsValidateBeforeCall(OffsetDateTime startAt, OffsetDateTime endAt, String filter, String sortBy, Integer limit, String page, String histogramInterval, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listAccessEvaluationLogsCall(startAt, endAt, filter, sortBy, limit, page, histogramInterval, _callback);
        return localVarCall;
     ...
     */
    public ResourceListWithHistogramOfAccessEvaluationLog listAccessEvaluationLogs(OffsetDateTime startAt, OffsetDateTime endAt, String filter, String sortBy, Integer limit, String page, String histogramInterval) throws ApiException {
     ...
     */
    public ApiResponse<ResourceListWithHistogramOfAccessEvaluationLog> listAccessEvaluationLogsWithHttpInfo(OffsetDateTime startAt, OffsetDateTime endAt, String filter, String sortBy, Integer limit, String page, String histogramInterval) throws ApiException {
     ...
     */
    public okhttp3.Call listAccessEvaluationLogsAsync(OffsetDateTime startAt, OffsetDateTime endAt, String filter, String sortBy, Integer limit, String page, String histogramInterval, final ApiCallback<ResourceListWithHistogramOfAccessEvaluationLog> _callback) throws ApiException {
